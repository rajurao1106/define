...
const TalkToGirlfriend = () => {
  ...
  const customizePrompt = (userInput) => {
    return `एक भारतीय प्रेमिका की तरह व्यवहार करो जो मुझसे फ़्लर्ट करती है और जब मैं हिंदी में जवाब देती हूँ तो मज़ाकिया ढंग से मुझसे सवाल करती है: "${userInput}"`;
  };
